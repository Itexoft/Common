...
public sealed class TextRewriteWriterAsyncTests
{
    ...
    public async Task PassThroughWhenNoRulesAsync()
    {
        ...
        await using var writer = new TextRewriteWriter(sink, plan);

        await writer.WriteAsync("alpha");
        await writer.WriteAsync(' ');
        await writer.WriteAsync("beta");
    ...
    public async Task SseOutputFilterAsyncIsFramed()
    {
        ...
        await using var sink = new StringWriter();
        await using var writer = new TextRewriteWriter(
            sink,
            plan,
            new()
            {
    ...
    public async Task LiteralRemovalTriggersAsyncHandler()
    {
        ...
        var plan = new TextRewritePlanBuilder()
            .RemoveLiteral(
                "secret",
                async (id, mem) =>
                {
        ...
        await writer.WriteAsync("keep secret hidden");
        await writer.FlushAsync();
    ...
    public async Task LiteralReplacementAsyncFactoryReceivesMemory()
    {
        ...
        await writer.WriteAsync("abc-abc");
        await writer.FlushAsync();
    ...
    public async Task RegexPlusAppliedOncePerSpanAsync()
    {
        ...
        await writer.WriteAsync("aaxxbb");
        await writer.FlushAsync();
    ...
    public async Task AsyncRuleGateBlocksThenAllows()
    {
        ...
        await writer.WriteAsync("abcabc");
        await writer.FlushAsync();
