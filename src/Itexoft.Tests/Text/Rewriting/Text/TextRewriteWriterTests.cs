...
public sealed class TextRewriteWriterTests
{
    ...
    public void RuleOrderBreaksPriorityTiesAcrossRuleTypes()
    {
        var plan = new TextRewritePlanBuilder()
            ...
            .ReplaceRegex(new Regex("foo"), 3, "R", 0)
            .Build();
    ...
    {
        var plan = new TextRewritePlanBuilder()
            .ReplaceRegex(new Regex("x."), 2, (id, span, metrics) => $"{metrics.ProcessedChars}:{span.ToString()}")
            .Build();
