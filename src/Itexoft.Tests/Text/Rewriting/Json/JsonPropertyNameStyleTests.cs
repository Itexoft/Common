...
public sealed class JsonPropertyNameStyleTests
{
    ...
    [Test]
    public void CamelCaseLowercasesFirstLetter()
    {
        Assert.That(JsonPropertyNameHelper.Convert("TestCase", JsonPropertyNameStyle.CamelCase), Is.EqualTo("testCase"));
    }

    [Test]
    public void ExactKeepsOriginalName()
    {
        Assert.That(JsonPropertyNameHelper.Convert("TestCase", JsonPropertyNameStyle.Exact), Is.EqualTo("TestCase"));
    }
}