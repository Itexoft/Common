...
{
    [TerminalDisplay("Login")]
    [TerminalCharacterSet(Message = "Login must be alphanumeric.")]
    ...
    [TerminalDisplay("Notes")]
    [TerminalRegex(@"^.{0,140}$", Message = "Notes must be 140 characters or less.")]
