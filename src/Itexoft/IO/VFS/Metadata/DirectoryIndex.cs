...
internal sealed class DirectoryIndex
{
    ...
    {
        if (!this.fileTable.TryGet(directoryId, out var metadata) || metadata.Kind != FileKind.Directory)
