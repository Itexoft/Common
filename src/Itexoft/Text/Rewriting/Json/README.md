...
This module rewrites JSON structures: replace values, rename fields, validate, extract data, and convert to strongly typed objects. All of this works over a stream without holding the whole payload in memory.
