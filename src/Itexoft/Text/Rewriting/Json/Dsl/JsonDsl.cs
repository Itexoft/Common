    ...
    where THandlers : class
{
        ...
        string? name = null)
    {
        ...
        if (predicate is not null)
            predicateWrapped = value => predicate(
        ...
        where T : class
    {
        ...
        this.builder.CaptureObject<THandlers, T>(
            rootPointer,
            projection,
            onObject,
            name,
        ...
        where T : class
    {
        ...
        this.builder.CaptureMany<THandlers, T>(
            rootPointer,
            projection,
            (handler, model) => onItem(handler, model),
            name,
            this.currentGroup);
        ...
        string? name = null)
    {
        ...
        this.builder.CaptureValue<THandlers, T>(
            pointer,
            onValue,
            converter,
            name,
