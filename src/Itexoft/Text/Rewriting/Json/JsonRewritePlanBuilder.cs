...
public sealed class JsonRewritePlanBuilder : RewritePlanBuilder<JsonRewritePlanBuilder, JsonRewritePlan>
{
    ...
    /// <param name="name">Optional rule name.</param>
    /// <param name="group">Optional rule group.</param>
    public JsonRewritePlanBuilder CaptureAsync(
        string jsonPointer,
        Func<string, ValueTask> onValueAsync,
        string? name = null,
        string? group = null)
    {
        ArgumentNullException.ThrowIfNull(jsonPointer);
        ArgumentNullException.ThrowIfNull(onValueAsync);
    ...
    public JsonRewritePlanBuilder CaptureObject<T>(
        ...
        where T : class
    {
        ArgumentNullException.ThrowIfNull(rootPointer);
        ArgumentNullException.ThrowIfNull(projection);
        ArgumentNullException.ThrowIfNull(onObject);
        ...
        string? group = null)
    {
        ...
        this.AddRule(
            new CaptureRule(pointer, literal => onValue(converterFunc(DecodeScalarLiteral(literal)))),
            "CaptureValue",
            pointer,
            name,
            group);
    ...
    {
        ArgumentNullException.ThrowIfNull(jsonPointer);
        ArgumentNullException.ThrowIfNull(replacerAsync);
        ...
        string? group = null)
    {
        ...
        this.AddRule(
            new ReplaceInStringRule(ctx => predicate(ctx.Value), ctx => replacer(ctx.Value)),
            "ReplaceInString",
            null,
            name,
            group);
        ...
        string? group = null)
    {
        ...
        this.AddRule(
            new ReplaceInStringRule(jsonPointer, predicateAsync, replacerAsync),
            "ReplaceInString",
            jsonPointer,
            name,
            group);
