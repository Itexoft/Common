...
Этот модуль отвечает за переписывание JSON‑структур: замена значений, переименование полей, проверка, извлечение данных и конвертация в строго типизированные объекты. Всё это можно делать поверх потока, без хранения всего стрима в памяти.
