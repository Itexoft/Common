    ...
    where THandlers : class
{
    ...
    /// </summary>
    public TextRuleBuilder<THandlers> Literal(string pattern, StringComparison comparison = StringComparison.Ordinal, string? name = null)
        => new(
            this.builder,
            this.Scope,
            this.ruleNames,
    ...
    /// </summary>
    public TextRuleBuilder<THandlers> Regex(Regex regex, int maxMatchLength, string? name = null)
        => new(
            this.builder,
            this.Scope,
            this.ruleNames,
    ...
    /// </summary>
    public TextRuleBuilder<THandlers> Tail(int maxMatchLength, TailMatcher matcher, string? name = null)
        => new(
            this.builder,
            this.Scope,
            this.ruleNames,
