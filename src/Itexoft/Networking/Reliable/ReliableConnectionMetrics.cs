...
public readonly struct ReliableDialRateMetric(string endpointKey, int attemptsLastMinute, DateTimeOffset blacklistedUntilUtc)
{
    /// <summary>
    ...
    /// </summary>
    public int AttemptsLastMinute { get; } = attemptsLastMinute;

    /// <summary>
    /// Expiration timestamp of the current blacklist penalty.
    /// </summary>
    public DateTimeOffset BlacklistedUntilUtc { get; } = blacklistedUntilUtc;
}