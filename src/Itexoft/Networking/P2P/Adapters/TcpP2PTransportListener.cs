...
public sealed class TcpP2PTransportListener(TcpP2PTransportListenerOptions? options = null) : IAsyncDisposable
{
    private readonly Channel<P2PTransportConnection> _accepted = Channel.CreateUnbounded<P2PTransportConnection>(
        new()
        {
    ...
    private readonly TcpP2PTransportListenerOptions _options = options ?? new TcpP2PTransportListenerOptions();
