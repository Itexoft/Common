...
public sealed class P2PConnectionHost : IAsyncDisposable
{
    ...
    public P2PConnectionHost(P2PConnectionHostOptions options)
    {
        ...
        this._listener = new(this._options.TransportListenerOptions);
    }
...
{
    public P2PTransportConnection Connection { get; } = connection;
    public string RemoteNodeId { get; } = remoteNodeId;
    public IReadOnlyDictionary<string, string>? Metadata { get; } = metadata;
    public string? RemoteSessionId { get; } = remoteSessionId;
    public string? LocalSessionId { get; } = localSessionId;
}