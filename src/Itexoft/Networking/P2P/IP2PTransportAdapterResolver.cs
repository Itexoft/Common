...
internal sealed class SingleTransportAdapterResolver(IP2PTransportAdapter adapter) : IP2PTransportAdapterResolver
{
    private readonly IP2PTransportAdapter _adapter = adapter ?? throw new ArgumentNullException(nameof(adapter));
