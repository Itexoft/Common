...
/// </summary>
public sealed class P2PConnectionStateChangedEventArgs(
    ...
    : EventArgs
{
    public P2PConnectionState PreviousState { get; } = previous;

    public P2PConnectionState CurrentState { get; } = current;

    /// <summary>
    /// Classification of the event that triggered the transition.
    /// </summary>
    public P2PConnectionTransitionCause Cause { get; } = cause;
