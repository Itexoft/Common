...
{
    private readonly ITerminalFormFieldValidator _validator;
    ...
    public TerminalNumberRangeAttribute(byte min, byte max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<byte>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(sbyte min, sbyte max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<sbyte>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(short min, short max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<short>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(ushort min, ushort max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<ushort>(min, max, message);

    /// <summary>
    /// Initializes the attribute for <see cref="int" /> values.
    /// </summary>
    public TerminalNumberRangeAttribute(int min, int max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<int>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(uint min, uint max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<uint>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(long min, long max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<long>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(ulong min, ulong max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<ulong>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(float min, float max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<float>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(double min, double max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<double>(min, max, message);
    ...
    public TerminalNumberRangeAttribute(decimal min, decimal max, string? message = null) =>
        this._validator = new NumericRangeFieldValidator<decimal>(min, max, message);

    /// <inheritdoc />
    public override ITerminalFormFieldValidator CreateValidator() => this._validator;
}