...
{
    private readonly DataBindingKey _column;
    private readonly Dictionary<string, TerminalCellStyle> _styles = new(StringComparer.OrdinalIgnoreCase);

    internal TerminalCellStyleRuleBuilder(DataBindingKey column) => this._column = column;
