...
/// </summary>
public sealed class TerminalInputComposer<TScreen>
    where TScreen : TerminalComponentDefinition
{
    private readonly TerminalUiBuilder<TScreen> _builder;

    internal TerminalInputComposer(TerminalUiBuilder<TScreen> builder) => this._builder = builder;
    ...
    {
        this._builder.BindInput(TerminalNavigationMode.Accelerator, gesture, action);
    ...
    {
        this._builder.BindInput(TerminalNavigationMode.Numeric, gesture, action);
    ...
    {
        this._builder.BindInput(TerminalNavigationMode.Arrow, gesture, action);
