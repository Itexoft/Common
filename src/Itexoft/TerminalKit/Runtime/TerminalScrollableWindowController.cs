...
{
    private readonly Func<int> _countProvider = countProvider ?? throw new ArgumentNullException(nameof(countProvider));
    private readonly TerminalViewportState _viewport = viewport ?? throw new ArgumentNullException(nameof(viewport));
