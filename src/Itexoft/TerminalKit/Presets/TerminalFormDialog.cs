...
{
    private readonly IReadOnlyList<TerminalFormFieldDefinition> _fields;
    ...
    public TerminalFormDialog(IReadOnlyList<TerminalFormFieldDefinition> fields) =>
        this._fields = fields ?? throw new ArgumentNullException(nameof(fields));
    ...
    public IDictionary<DataBindingKey, string?> Prompt(
        ...
        Func<TerminalFormFieldDefinition, IReadOnlyList<string>?>? optionsProvider = null)
    {
        return RunWithExternalScope(() =>
        {
            try
            {
