...
internal static class TerminalCrudTablePreset
{
    public static void Build(
        ...
        TerminalEventKey cellEditedEvent)
    {
        builder
            .BindState(t => t.DataSource, itemsState)
            .BindState(t => t.ViewportState, viewportState)
            .Set(t => t.Columns, columns)
            .BindEvent(cellEditedEvent, handlers.UpdateField);
    }
}