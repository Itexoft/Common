    ...
    where TKey : notnull
{
    ...
    private sealed class Enumerator(ConcurrentDictionaryEx<TKey, TValue> dictionary) : IEnumerator<KeyValuePair<TKey, TValue>>
    {
        ...
        public bool MoveNext()
        {
            switch (this._state)
            {
                case StateUninitialized:
                    this._buckets = dictionary._tables._buckets;
                    this._i = -1;
