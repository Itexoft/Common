...
public static class EmbeddedArchiveSource
{
    ...
    private sealed class DelegateArchiveSource(Func<CancellationToken, ValueTask<Stream>> factory) : IEmbeddedArchiveSource
    {
        private readonly Func<CancellationToken, ValueTask<Stream>> _factory = factory ?? throw new ArgumentNullException(nameof(factory));
