    ...
    where TKey : notnull
{
    ...
    {
        return this.TryRemove(item, null);
    }
    ...
    {
        return this.TryAddInternal<object>(tables, key, nullableHashcode, (_,_) => value, updateIfExists, acquireLock, null!, out resultingValue);
    }
    ...
    private bool TryAddInternal(
        ...
        out TValue resultingValue)
    {
        return this.TryAddInternal<object>(tables, key, nullableHashcode, (k, _) => getValue(k), updateIfExists, acquireLock, null!, out resultingValue);
    }
    ...
    {
        return !this._tables._countPerLock.AsSpan().ContainsAnyExcept(0);
    }
    ...
    private sealed class DictionaryEnumerator : IDictionaryEnumerator
    {
        ...
        internal DictionaryEnumerator(ConcurrentDictionaryEx<TKey, TValue> dictionary)
        {
    ...
    public readonly struct AlternateLookup<TAlternateKey> where TAlternateKey : notnull, allows ref struct
    {
        ...
        {
            return this.TryAdd(key, value, false, out _);
        }
        ...
        {
            return this.TryGetValue(key, out _, out value);
        }
        ...
        {
            return this.TryRemove(key, predicate, out _, out value);
        }
    ...
    {
        return this.TryGetValue(keyValuePair.Key, out var value)
